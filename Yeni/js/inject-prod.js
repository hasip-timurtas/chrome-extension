class InjectProd {
  ...
  GetSellPrice() {
    ...
    if (alimSatimYuzdeFarki >= this.bizimTutarin3te1i ){
      console.log('Yüde farkı yeterince var, kârdan koyuyor. en üste.')
      return satacagiFiyat
    }
      
    // Yukarıdaki değilse kârını koy arka sıralarda dursun
    console.log('GetSellPrice fiyatı düştü arkaya koyuluyor.')
